...
public class CourseModuleRepository : ICourseModuleRepository
{
    ...
    public async Task<List<CourseModuleDtos>> GetAllAsync()
    {
        try
        {
    ...
    public async Task<CourseModuleDtos?> Read(Guid id)
    {
        try
        {
    ...
    public async Task<CourseModuleDtos?> Update(UpdateCourseModuleRequestDto dto)
    {
        try
        {
    ...
    /// </summary>
    private static CourseModuleDtos GetCourseModuleDto(CourseModuleEntity entity)
    {
        return new CourseModuleDtos(
            entity.Id,
            entity.Name,
            entity.Description,
            new CourseThemeDtos(
    ...
    /// </summary>
    private static List<CourseModuleDtos> GetCourseModuleDto(List<CourseModuleEntity> entities)
    {
        return entities.Select(e => new CourseModuleDtos(
            e.Id,
            e.Name,
            e.Description,
            new CourseThemeDtos(
